...
public class MinHeapIntTests {
  ...
  public void testMinHeap() {
    ...
    Assert.assertEquals(minHeap.peek(), Integer.valueOf(5));

    minHeap.add(-1);
    Assert.assertEquals(minHeap.getLength(), 2);
    Assert.assertEquals(minHeap.peek(), Integer.valueOf(-1));
    ...
    Assert.assertEquals(minHeap.pop(), Integer.valueOf(-5));
    Assert.assertEquals(minHeap.pop(), Integer.valueOf(-1));
    Assert.assertEquals(minHeap.pop(), Integer.valueOf(5));
    Assert.assertEquals(minHeap.pop(), Integer.valueOf(100));
  }
}
